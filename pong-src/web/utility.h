#pragma once
/* Web port: the Windows/console headers are replaced by the compat shim.
 * Standard headers are included FIRST so the shim's macros only rewrite the
 * game's own call sites, never the C library. */
#include <time.h>
#include <stdlib.h>
#include <stdbool.h>
#include <stdio.h>
